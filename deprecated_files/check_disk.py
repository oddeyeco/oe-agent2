    ...
    try:
        ...
        for index in range(0, len(partitions)):
            ...
            if disk == '/':
                ...
                jsondata.gen_data('drive'+diskname+'_used_bytes', timestamp, roottuple[1], push.hostname, check_type, cluster_name, reaction)
                jsondata.gen_data('drive'+diskname+'_free_bytes', timestamp, roottuple[2], push.hostname, check_type, cluster_name, reaction)
                ...
                jsondata.gen_data('drive'+diskname+'_used_bytes', timestamp, disktuple[1], push.hostname, check_type, cluster_name, reaction)
                jsondata.gen_data('drive'+diskname+'_free_bytes', timestamp, disktuple[2], push.hostname, check_type, cluster_name, reaction)
                jsondata.gen_data('drive'+diskname+'_pecent', timestamp, disktuple[3], push.hostname, check_type, cluster_name, reaction)
        ...
        for key, value in disks.iteritems():
            ...
            jsondata.gen_data(read_name, timestamp, readrate, push.hostname, check_type, cluster_name, reaction)
            jsondata.gen_data(write_name, timestamp, writerate, push.hostname, check_type, cluster_name, reaction)
        jsondata.put_json()
