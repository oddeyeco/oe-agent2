**PuyPuy**
---------
PuyPuy is python2 metrics collection daemon, which works with KairosDB, OpenTDB, Graphite and soon with BlueFlood, For KairosDB and OpenTSDB it uses REST interface, for Graphite Pickle.
