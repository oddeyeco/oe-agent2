            ...
            if errorIndication:
                ...
                if errorStatus:
                    ...
                    for name, val in varBinds:
                        local_vars.append({'name': 'snmp_' + n, 'timestamp': timestamp, 'value': val, 'hostname' : host})
        def getValuesT(name, oid, srv, prt, host, authProto, privProto, SecName, AuthPass, PrivPass):
            ...
            if errorIndication:
                ...
                for varBind in varBinds:
                    ...
                    local_vars.append({'name': 'snmp_' + name, 'timestamp': timestamp, 'value': value , 'hostname' : host})
